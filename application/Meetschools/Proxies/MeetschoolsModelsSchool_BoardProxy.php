 ...
 */
class InternshalaModelsSchool_BoardProxy extends \Internshala\Models\School_Board implements \Doctrine\ORM\Proxy\Proxy {
    ...
    public function set_board(\Internshala\Models\Board $board) {
        $this->__load();
        return parent::set_board($board);
    }
    ...
    public function __sleep() {
        return array('__isInitialized__', 'id', 'school', 'board', 'created_at', 'last_updated_at');
    }
