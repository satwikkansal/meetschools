            ...
            <div class="profile-body">
                <div class="panel panel-profile">
                    <div class="panel-heading overflow-h">
                        <h2 class="panel-title heading-sm pull-left"><i class="fa fa-comments"></i>My Suggestions</h2>
                ...
                <form action="assets/php/demo-comment-process.php" method="post" id="sky-form5" class="sky-form">
                    <header>Submit your suggestion below:</header>
                    ...
                    <div class="message">
                        ...
                        <p>Your suggestion was successfully added!</p>
                    </div>
                </form>
            </div>
        </div>
