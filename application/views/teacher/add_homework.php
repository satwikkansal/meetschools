            ...
            <div class="profile-body">
                    ...
                    <div class="panel-body margin-bottom-50">
                        <div class="media media-v2">
                            <a class="pull-left" href="#">
                                <img class="media-object rounded-x" src="https://pbs.twimg.com/profile_images/490643057822273537/pMkrGQPT_400x400.jpeg" alt="">
                            </a>
                ...
                <div class="panel panel-profile">
                    ...
                    <div class="panel-body">
                        <div class="media media-v2 margin-bottom-20">
                            <a class="pull-left" href="#">
                                <img class="media-object rounded-x" src="/static/img/testimonials/img6.jpg" alt="">
                            </a>
                            <div class="media-body">
                                <h4 class="media-heading">
                                ...
                                <ul class="list-inline img-uploaded">
                                    <li><img class="img-responsive" src="/static/img/main/img12.jpg" alt=""></li>
                                    <li><img class="img-responsive" src="/static/img/main/img3.jpg" alt=""></li>
                                    <li><img class="img-responsive" src="/static/img/main/img16.jpg" alt=""></li>
                                </ul>
                                <ul class="list-inline results-list pull-left">
