...
<div class="container content profile">
    <div class="row">
        ...
        <div class="col-md-3 md-margin-bottom-40">
            <img class="img-responsive profile-img margin-bottom-20" src="/static/img/team/img32-md.jpg" alt="">
            ...
            <ul class="list-group sidebar-nav-v1 margin-bottom-40" id="sidebar-nav-1">
                ...
                <li class="list-group-item">
                    <a href="/teacher/profile"><i class="fa fa-user"></i> Profile</a>
                </li>
                <li class="list-group-item">
            ...
            <ul class="list-unstyled mCustomScrollbar margin-bottom-20" data-mcs-theme="minimal-dark">
                ...
                <li class="notification">
                    <img class="rounded-x" src="/static/img/testimonials/img6.jpg" alt="">
                    <div class="overflow-h">
                    ...
                    <div class="col-sm-5">
                        <div class="panel panel-profile">
                            ...
                            <div id="scrollbar4" class="panel-body no-padding mCustomScrollbar" data-mcs-theme="minimal-dark">
                                <div class="comment">
                                    <img src="/static/img/testimonials/img6.jpg" alt="">
                                    <div class="overflow-h">
                                ...
                                <div class="comment">
                                    <img src="/static/img/testimonials/img2.jpg" alt="">
                                    <div class="overflow-h">
                                ...
                                <div class="comment">
                                    <img src="/static/img/testimonials/img4.jpg" alt="">
                                    <div class="overflow-h">
                                ...
                                <div class="comment">
                                    <img src="/static/img/testimonials/img1.jpg" alt="">
                                    <div class="overflow-h">
                                ...
                                <div class="comment">
                                    <img src="/static/img/testimonials/img7.jpg" alt="">
                                    <div class="overflow-h">
