    ...
    <div class="container content">
    	<div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                <form class="reg-page" id="login-form" novalidate="novalidate" role="form">
...
<!--                        <div class="col-md-6 checkbox">
    ...
    <script type="text/javascript" src="/static/plugins/jquery/additional-methods.min.js"></script>
