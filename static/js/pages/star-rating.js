(function ($) {
    ...
    $.fn.rating.defaults = {
        ...
        starCaptionClasses: {
            ...
            1.1: 'label label-orange',
            1.2: 'label label-orange',
            1.3: 'label label-orange',
            1.4: 'label label-orange',
            1.5: 'label label-orange',
            1.6: 'label label-orange',
            1.7: 'label label-orange',
            1.8: 'label label-orange',
            1.9: 'label label-orange',
            2: 'label label-orange',
